<script lang="ts">
	...
	import type { StackerStats } from '$types/stacking_types';
	import { getStackerInfo } from '$lib/pox_api';
	import VoteAnalysis from './VoteAnalysis.svelte';
	import StackerContractInfo from './StackerContractInfo.svelte';
	import StackerEvents from './StackerEvents.svelte';
	import RewardSlotAnalysis from './RewardSlotAnalysis.svelte';
